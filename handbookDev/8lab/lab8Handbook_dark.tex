...
\begin{figure}[H]
	\centering
	\subfloat[Регистрация первого покупателя]{\includegraphics[width=0.45\textwidth]{fig/2.png} \label{fig:reg_customer1}}
	\hfil
	\subfloat[Регистрация второго покупателя]{\includegraphics[width=0.45\textwidth]{fig/3.png} \label{fig:reg_customer2}}
	\hfil
	\subfloat[Регистрация «Администратора»]{\includegraphics[width=0.45\textwidth]{fig/1.png} \label{fig:reg_admin}}
	\hfil
