...
\begin{figure}[H]
	\centering
	\subfloat[Форма входа]{\includegraphics[width=0.45\textwidth]{fig/2} \label{fig:login_form}}
	\hfil
	\subfloat[Форма регистрации]{\includegraphics[width=0.45\textwidth]{fig/3} \label{fig:register_form}}
	\hfil
	\subfloat[Окно успешной регистрации]{\includegraphics[width=0.45\textwidth]{fig/4} \label{fig:success_registration_window}}
